...
export const REMOVE_POKEMON_BY_ID_PENDING = 'REMOVE_POKEMON_BY_ID_PENDING'

export const REMOVE_POKEMON_BY_ID_FULFILLED = 'REMOVE_POKEMON_BY_ID_FULFILLED'

export const REMOVE_POKEMON_BY_ID_REJECTED = 'REMOVE_POKEMON_BY_ID_REJECTED'
...
export const REMOVE_POKEMON_BY_ID_LOCAL = 'REMOVE_POKEMON_BY_ID_LOCAL'
